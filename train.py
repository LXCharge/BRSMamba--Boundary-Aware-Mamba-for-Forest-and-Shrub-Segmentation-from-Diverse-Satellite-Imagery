...
def get_args():
    ...
    arg("-m", "--model_name", type=str, help="Name of the model.", required=True)
    arg("-b" "--backbone_name", type=str, help="Name of the backbone.", required=True)
    arg("-e", "--epochs", type=int, help="Max epochs.", default=200)
    arg("-bs", "--batch_size", type=int, help="Batch size.", default=8)
    arg("-lr", "--lr", type=float, help="Learning rate.", default=6e-3)
    arg("-blr", "--backbone_lr", type=float, help="Base learning rate.", default=6e-4)
    arg("-wd", "--weight_decay", type=float, help="Weight decay.", default=1e-3)
    arg(
        "-bwd",
    ...
    arg("-d", "--dataset_name", type=str, help="Name of the dataset.", required=True)
    arg("-aux", "--use_aux_loss", type=bool, help="Use aux loss.", default=False)
    arg("-alpha", "--aux_loss_weight", type=float, help="Aux loss weight.", default=0.4)
    arg("-g", "--gpus", type=str, help="Number of gpus.", default="auto")
