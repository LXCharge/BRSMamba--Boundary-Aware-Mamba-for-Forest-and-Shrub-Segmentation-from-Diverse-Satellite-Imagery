...
class Supervision_Train(pl.LightningModule):
    ...
    def forward(self, x, *args, **kwargs):
        ...
        seg_pre = self.net(x, *args, **kwargs)
        return seg_pre
    ...
    def training_step(self, batch, batch_idx):
        ...
        memory_log = {
            "allocated_memory(MB)": allocated_memory / 1024**2,
            "cached_memory(MB)": cached_memory / 1024**2,
        }
        self.log_dict(memory_log, prog_bar=False, sync_dist=True)
        return {"loss": loss}
