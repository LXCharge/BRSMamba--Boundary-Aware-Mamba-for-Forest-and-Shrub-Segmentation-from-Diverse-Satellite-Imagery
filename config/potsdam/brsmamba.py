...
val_dataset = PotsdamDataset(data_root="data/potsdam_t/test", transform=val_aug)
test_dataset = PotsdamDataset(data_root="data/potsdam_t/test", transform=val_aug)
