...
class WindowAttention(nn.Module):
    ...
    def __init__(
        ...
        coords = torch.stack(
            torch.meshgrid([coords_h, coords_w], indexing="xy")
        )  # 2, Wh, Ww
...
def dcswin_base(
    pretrained=True, num_classes=4, weight_path="pretrained_ckpt/stseg_base.pth"
):
...
def dcswin_small(
    pretrained=True, num_classes=4, weight_path="pretrained_ckpt/stseg_small.pth"
):
    model = DCSwin(
        encoder_channels=(96, 192, 384, 768),
        num_classes=num_classes,
...
def dcswin_tiny(
    pretrained=True, num_classes=4, weight_path="pretrained_ckpt/stseg_tiny.pth"
):
    model = DCSwin(
        encoder_channels=(96, 192, 384, 768),
        num_classes=num_classes,
...
if __name__ == "__main__":
    model = dcswin_base(pretrained=True, num_classes=4)
