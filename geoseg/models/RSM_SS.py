...
class SelectiveScanFake(torch.autograd.Function):
    ...
    def backward(ctx, dout, *args):
        ...
        du, ddelta, dA, dB, dC, dD, ddelta_bias = (
            ...
            C * 0,
            (D * 0 if D else None),
            (delta_bias * 0 if delta_bias else None),
        )
        return (du, ddelta, dA, dB, dC, dD, ddelta_bias, None, None, None, None)
...
class OSSM(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        FORWARD_TYPES = dict(
            ...
            v2=partial(
                self.forward_corev2, force_fp32=True, SelectiveScan=SelectiveScanCore
            ),
            v3=partial(
            ...
            fake=partial(
                ...
                SelectiveScan=SelectiveScanFake,
            ),
            v1=partial(
    ...
    def forward_corev0(self, x: torch.Tensor, to_dtype=False, channel_first=False):
        def selective_scan(
            ...
            return SelectiveScanCore.apply(
...
class RSM_SS(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(ssm_act_layer, str) and ssm_act_layer.lower() in [
            "silu",
            "gelu",
            "relu",
        ]:
        ...
        self.conv_out_seg = nn.Conv2d(
            8, self.num_classes, kernel_size=7, stride=1, padding=3
        )
