...
class MLPBlock(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.lin1 = SVDLinear(embedding_dim, mlp_dim, r=lora_rank)
        self.lin2 = SVDLinear(mlp_dim, embedding_dim, r=lora_rank)
        self.act = act()
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        self.qkv = SVDLinear(dim, dim * 3, bias=qkv_bias, r=lora_rank)
