...
from backbone.efficientvit import (
...
def efficientvit_seg_b0(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_b0
...
def efficientvit_seg_b1(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_b1
...
def efficientvit_seg_b2(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_b2
...
def efficientvit_seg_b3(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_b3
...
def efficientvit_seg_l1(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_l1
...
def efficientvit_seg_l2(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone.efficientvit import efficientvit_backbone_l2
...
if __name__ == "__main__":
    model = efficientvit_seg_b3("cityscapes", **{"norm": "bn2d", "act_func": "relu6"})
