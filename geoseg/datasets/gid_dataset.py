...
CLASSES = ("ImSurf", "Building", "Water", "Forest", "Meadow", "Farmland")
PALETTE = [
    [255, 255, 255],
    [255, 0, 0],
    [0, 0, 255],
...
def get_training_transform():
    train_transform = [
        ...
        albu.RandomBrightnessContrast(
            brightness_limit=(-0.2, 0.2), contrast_limit=(-0.2, 0.2), p=0.25
        ),
        albu.Blur(blur_limit=(3, 7), p=0.5),
        ...
        # albu.Sharpen(alpha=(0.2, 0.5), lightness=(0.5, 1.0), p=0.3),  # 锐化
        albu.Normalize(),
    ]
